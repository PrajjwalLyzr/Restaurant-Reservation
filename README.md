# Welcome to the Restaurant-Reservation by Lyzr!

![Lyzr Logo](./logo/lyzr-logo.png)

This Restaurant Reservation utilizing Lyzr ChatBot and VoiceBot to provide the reponses to the user. Users need to ask their query and this app will use ChatBot & VoiceBot to provide the solutions for user query regarding restaurant reservations.
